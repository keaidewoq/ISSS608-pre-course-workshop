...
In this hands-on exercise, I will create interactive data visualisation by using functions provided by **ggiraph** and **plotlyr** packages.
...
[ggiraph](https://davidgohel.github.io/ggiraph/index.html) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="22" height="25"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
"https://www.moe.gov.sg/schoolfinder?jouney=Primary%20school",
...
### 6.7 Cordinated Multiple Views with ggiraph
...
## 8 Interative Data Visualisation - crosstalk methods!
