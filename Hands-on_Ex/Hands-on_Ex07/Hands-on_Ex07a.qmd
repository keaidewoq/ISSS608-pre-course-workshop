...
-   Master Plan 2014 Subzone Boundary (Web) (i.e. `MP14_SUBZONE_NO_SEA_PL`) in ESRI shapefile format. It can be downloaded at [data.gov.sg](https://data.gov.sg/) This is a geospatial data. It consists of the geographical boundary of Singapore at the planning subzone level. The data is based on URA Master Plan 2014.

-   Singapore Residents by Planning Area / Subzone, Age Group, Sex and Type of Dwelling, June 2011-2020 in csv format (i.e. `respopagesextod2011to2020.csv`). This is an aspatial data fie. It can be downloaded at [Department of Statistics, Singapore](https://www.singstat.gov.sg/) Although it does not contain any coordinates values, but it’s PA and SZ fields can be used as unique identifiers to geocode to `MP14_SUBZONE_NO_SEA_PL` shapefile.

### 3.2 Importing Geospatial Data into R

The code chunk below uses the *st_read()* function of **sf** package to import `MP14_SUBZONE_NO_SEA_PL` shapefile into R as a simple feature data frame called `mpsz`.
...
The `sf` package uses **tibble**-style printing. In R, a tibble is designed to keep your console clean by default.

-   **Automatic Truncation:** If a dataset has hundreds of rows, R will only show the first 10 so it doesn't "flood" your screen with thousands of lines of text.
:::
...
-   The default colour scheme used is `Blues` of ColorBrewer. You will learn more about the color scheme in sub-section 4.4.
...
In this example, small multiple choropleth maps are created by passing a vector of variables to **tm_fill()**
