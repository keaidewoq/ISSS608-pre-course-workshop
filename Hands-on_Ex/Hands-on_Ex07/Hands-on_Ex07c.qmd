...
For the purpose of this hands-on exercise, a prepared data set called *NGA_wp.rds* will be used. The data set is a polygon feature data.frame providing information on water point of Nigeria at the Local Government Area (LGA) level. You can find the data set in the *rds* sub-direct of the hands-on *data* folder.
...
The choropleth map below shows the distribution of percentage functional water point by LGA.
