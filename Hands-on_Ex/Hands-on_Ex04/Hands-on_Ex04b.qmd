...
[**ggstatsplot**](https://indrajeetpatil.github.io/ggstatsplot/index.html) ![](https://r4va.netlify.app/chap10/img/image1.jpg){width="33" height="39"} is an extension of [**ggplot2**](https://ggplot2.tidyverse.org/) package for creating graphics with details from statistical tests included in the information-rich plots themselves.
...
![](images/clipboard-1698177041.png){width="400"}
...
![![](images/clipboard-3020069380.png)](images/clipboard-3825704737.png)
