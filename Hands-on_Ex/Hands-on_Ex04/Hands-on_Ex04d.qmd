...
```{r}
pacman::p_load(tidyverse, FunnelPlotR, plotly, knitr, ggplot2)
```
...
p <- ggplot(df, aes(x = Positive, y = rate)) +
  ...
  annotate("text", x = 500, y = 0.045, label = "95%", size = 3, colour = "grey40") + 
  annotate("text", x = 300, y = 0.030, label = "99.9%", size = 3, colour = "grey40") + 
